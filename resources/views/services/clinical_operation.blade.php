    ...
    <main class="main">
        ...
        <div class="page-title dark-background">
            <div class="container position-relative">
                <h1>Clinical Operation & Project Management</h1>
...
{{--                            <h2>Clinical Operation Services</h2>--}}
                        ...
                        <p>
                            Eric Solutions Clinical Monitoring offers Optimized solution with
                        </p>
                        ...
                        <table class="table table-bordered table-dark table-hover">
                            <thead>
                            <tr>
                                <th scope="col">Data Integrity</th>
                                <th scope="col">Patient Safety</th>
                                <th scope="col">Protocol Adherence</th>
                                <th scope="col">Regulatory Compliance</th>
                                <th scope="col">Timely Reporting</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="service-box">
                            ...
                            <div class="services-list">
                                <a href="/clinical_operation" class="active"><i class="bi bi-arrow-right-circle"></i><span>Clinical Operation & Project Management</span></a>
                                ...
                                <a href="/clinical_data"><i class="bi bi-arrow-right-circle"></i><span>Clinical Data Standard</span></a>
