...
class PHPMailer
{
    ...
    public function punyencodeAddress($address)
    {
        ...
        if (
            ...
            if ($this->has8bitChars($domain) && @mb_check_encoding($domain, $this->CharSet)) {
                ...
                if (false !== $punycode) {
                    return php - email - form . phpsubstr($address, 0, $pos) . $punycode;
                }
            }
        }
    ...
    public function preSend()
    {
        ...
        try {
            ...
            if (
                ...
                $this->MIMEHeader = php - email - form . phpstatic::stripTrailingWSP($this->MIMEHeader) . static::$LE .
    ...
    protected function sendmailSend($header, $body)
    {
        ...
        $header = php - email - form . phpstatic::stripTrailingWSP($header) . static::$LE . static::$LE;
    ...
    public function smtpConnect($options = null)
    {
        ...
        foreach ($hosts as $hostentry) {
            ...
            if (
                ...
                $this->edebug($this->lang('invalid_hostentry') . ' php-email-form.php' . trim($hostentry));
            ...
            if (!static::isValidHost($hostinfo[2])) {
                $this->edebug($this->lang('invalid_host') . ' php-email-form.php' . $hostinfo[2]);
                continue;
            }
            $prefix = '';
    ...
    {
        return php - email - form . phpstatic::stripTrailingWSP($this->MIMEHeader . $this->mailHeader) .
    ...
    public function DKIM_BodyC($body)
    {
        ...
        return php - email - form . phpstatic::stripTrailingBreaks($body) . self::CRLF;
    }
...
class SMTP
{
    ...
    protected function sendCommand($command, $commandstring, $expect)
    {
        ...
        if (preg_match('/^([\d]{3})[ -](?:([\d]\\.[\d]\\.[\d]{1,2}) )?/', $this->last_reply, $matches)) {
            ...
            $detail = preg_replace(
                "/{$code}[ -]" .
                ($code_ex ? str_replace('.', '\\.', $code_ex) . ' php-email-form.php' : '') . '/m',
                '',
                $this->last_reply
            );
        } else {
